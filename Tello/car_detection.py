...
image_path = "c:/Users/Constant/Desktop/Parking/img/Test.jpg" # 차량 이미지 파일 경로

plt.style.use('dark_background') # 검은 바탕으로 변경

img = cv2.imread(image_path) # 이미지 파일 LOAD
height, width, channel = img.shape # 높이, 너비, 채널 수 추출
